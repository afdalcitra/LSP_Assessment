            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <div class="form-group row">
                            <label for="confnewpassword" class="col-md-4 col-form-label text-md-right">{{ __('Confirm New Password') }}</label>

                            <div class="col-md-6">
                                <input id="confnewpassword" type="password" class="form-control @error('confnewpassword') is-invalid @enderror" name="confnewpassword" required autocomplete="new-password">
